...
class Session:
    ...
    def surface_parameters(self, face_ids: list[int]) -> dict[str, object]: ...
    ...
    def face_wires(self, face_ids: list[int]) -> dict[str, object]: ...
    def surface_at(
        self, face_id: int, uv: NDArray[np.float64]
    ) -> dict[str, object]: ...
    def distance(
        self, entity_id_a: int, entity_id_b: int
    ) -> dict[str, object]: ...
    def curve_at(
        self, edge_id: int, t: NDArray[np.float64]
    ) -> dict[str, object]: ...
    def curve_geometry(self, edge_ids: list[int]) -> dict[str, object]: ...
    def curvature(
