...
class Mesh:
    ...
    def add_segments(
        self, conn: NDArray[np.int64], edge_id: int
    ) -> NDArray[np.int64]: ...
    def add_triangles(
        self, conn: NDArray[np.int64], face_id: int
    ) -> NDArray[np.int64]: ...
    def remove_elements(
        self, element_ids: NDArray[np.int64], free_nodes: bool = False
    ) -> MeshRemoval: ...
    def remove_nodes(self, node_ids: NDArray[np.int64]) -> MeshRemoval: ...
